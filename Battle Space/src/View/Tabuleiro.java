...
public class Tabuleiro extends javax.swing.JFrame implements Observer {
  ...
  public Tabuleiro(ModelTabuleiro model) {
    ...
    //adicionando os botões sobre o panel que representa a parte inferior da tela de fundo do jogo
    ...
    button_nave1.setBounds(560, 30, 106, 94);  //posição
    ...
    //Adicionando os labels que apresentam as coordenadas do mouse sobre o panel
    ...
    //Adicionando os labels que apresentam os atributos das naves ( como vida, ataque ...) e deixando set visible false
  ...
  //adicionando os getters e setters dos labels que apresentam os atributos das naves
    ...
    //variaveis para verificar se o botão foi pressionado (mousePressed(MouseEvent e)) e printar (metodo drawMouseQuadrante) o png da nave selecionada na posição do cursor do mouse
 ...
 public void drawMouseQuadrante(Graphics2D g) { //desenha um quadrado ao redor dos quadrantesc
